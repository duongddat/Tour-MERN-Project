    ...
    <div className="tour-content">
        ...
        <div className="row mb-5">
          <div className="overview-box__group col-md-6">
            ...
            <div className="overview-box__detail">
              ...
              <span className="overview-box__text md">{tour.country.name}</span>
            </div>
            <div className="overview-box__detail">
              <svg
                className="overview-box__icon"
              ...
              tour.guides.map((guide) => (
                <div key={guide._id} className="overview-box__detail">
                  ...
                  <div className="d-flex flex-column">
                    ...
                    <span className="overview-box__text md">{guide.name}</span>
                  </div>
                </div>
              ))}
            {tour.guides.length === 0 && (
      ...
      <div className="mt-2 p-2">
        ...
        {tour.images.length === 0 && (
          <div className="text-center md">Đang cập nhật hình ảnh...</div>
        )}
      </div>
      <div className="mt-2 mb-5 p-2">
